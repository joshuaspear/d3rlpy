...
class Transition:
    def __init__(
        ...
        one_step_reg: Optional[float] = ...,
        q_reg: Optional[float] = ...,
    ): ...
    ...
    @property
    def one_step_reg(self) -> float: ...
    @property
    def q_reg(self) -> float: ...
    @property
...
class TransitionMiniBatch:
    ...
    @property
    def one_step_regs(self) -> np.ndarray: ...
    @property
    def q_regs(self) -> np.ndarray: ...
    @property
...
class Episode:
    def __init__(
        ...
        rewards: np.ndarray,
        terminal: bool = ...,
        one_step_regs: Optional[np.ndarray] = ...,
        q_regs: Optional[np.ndarray] = ...,
    ): ...
    @property
    def observations(self) -> np.ndarray: ...
    @property
